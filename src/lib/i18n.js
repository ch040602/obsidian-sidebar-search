...
const MESSAGES = {
  ko: {
    appTitle: 'Obsidian Sidebar Search',
    settingsTitle: 'Obsidian Sidebar Search 설정',
    settings: '설정',
    openSettings: '설정 열기',
    ...
    queryPlaceholder: '예: obsidian, machine-learning, #research',
    tag: '태그',
    fullText: '전체',
    currentPage: '현재 페이지',
    relatedNotes: '관련 노트',
    ...
    settingsSavedIndexPurged: '설정 저장 완료. 프라이버시 필터가 바뀌어 인덱스 재생성이 필요합니다.',
  ...
  en: {
    appTitle: 'Obsidian Sidebar Search',
    settingsTitle: 'Obsidian Sidebar Search Settings',
    settings: 'Settings',
    ...
    queryPlaceholder: 'Example: obsidian, machine-learning, #research',
    tag: 'Tag',
    fullText: 'Full',
    ...
    settingsSavedIndexPurged: 'Settings saved. Privacy filters changed, so rebuild the index.',
